...
<html>
    ...
    <body>
        ...
        <div class="lead">
            <label>您的位置：<a href="./index.jsp">首页</a> > 登录</label>
        </div>
        <div class="content" style="width: 480px;">
            ...
            <iframe src="" frameborder="0" name="loginBackContent" style="display: none;"></iframe> 
            <label></label>
            <label style="text-align: center;"><a href="./register.jsp">新用户？前往注册 >></a></label>
            <label></label>
            <label></label>
            <label></label>
            <label></label>
